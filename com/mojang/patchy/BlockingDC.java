...
public class BlockingDC implements DirContext {
   ...
   public Attributes getAttributes(String name, String[] attrIds) throws NamingException {
      return (Attributes)(this.blockList.test(name) ? new BasicAttributes() : this.parent.getAttributes(name, attrIds));
   }

   public Attributes getAttributes(String name) throws NamingException {
      return (Attributes)(this.blockList.test(name) ? new BasicAttributes() : this.parent.getAttributes(name));
   }
